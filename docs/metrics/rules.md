  ...
  - name: alertmanager.rules
    ...
    - alert: AlertmanagerFailedReload
      ...
      expr: |-
        ...
        max_over_time(alertmanager_config_last_reload_successful{job="cloudeka-kube-prometheus-s-alertmanager",namespace="monitoring"}[5m]) == 0
      for: 10m
      labels:
        severity: critical
    - alert: AlertmanagerMembersInconsistent
      ...
      expr: |-
        # Without max_over_time, failed scrapes could create false negatives, see
        # https://www.robustperception.io/alerting-on-gauges-in-prometheus-2-0 for details.
          max_over_time(alertmanager_cluster_members{job="cloudeka-kube-prometheus-s-alertmanager",namespace="monitoring"}[5m])
        < on (namespace,service,cluster) group_left
          count by (namespace,service,cluster) (max_over_time(alertmanager_cluster_members{job="cloudeka-kube-prometheus-s-alertmanager",namespace="monitoring"}[5m]))
      for: 15m
      labels:
        severity: critical
    - alert: AlertmanagerFailedToSendAlerts
      ...
      expr: |-
        (
          rate(alertmanager_notifications_failed_total{job="cloudeka-kube-prometheus-s-alertmanager",namespace="monitoring"}[5m])
        /
          ignoring (reason) group_left rate(alertmanager_notifications_total{job="cloudeka-kube-prometheus-s-alertmanager",namespace="monitoring"}[5m])
        )
        > 0.01
      for: 5m
      labels:
    ...
    - alert: AlertmanagerClusterFailedToSendAlerts
      ...
      expr: |-
        min by (namespace,service, integration) (
          rate(alertmanager_notifications_failed_total{job="cloudeka-kube-prometheus-s-alertmanager",namespace="monitoring", integration=~`.*`}[5m])
        /
          ignoring (reason) group_left rate(alertmanager_notifications_total{job="cloudeka-kube-prometheus-s-alertmanager",namespace="monitoring", integration=~`.*`}[5m])
        )
        > 0.01
      for: 5m
      labels:
    ...
    - alert: AlertmanagerConfigInconsistent
      ...
      expr: |-
        count by (namespace,service,cluster) (
          count_values by (namespace,service,cluster) ("config_hash", alertmanager_config_hash{job="cloudeka-kube-prometheus-s-alertmanager",namespace="monitoring"})
        )
        != 1
      for: 20m
      labels:
    ...
    - alert: AlertmanagerClusterDown
      ...
      expr: |-
        (
          count by (namespace,service,cluster) (
            avg_over_time(up{job="cloudeka-kube-prometheus-s-alertmanager",namespace="monitoring"}[5m]) < 0.5
          )
        /
          count by (namespace,service,cluster) (
            up{job="cloudeka-kube-prometheus-s-alertmanager",namespace="monitoring"}
          )
        )
        >= 0.5
      for: 5m
    ...
    - alert: AlertmanagerClusterCrashlooping
      ...
      expr: |-
        (
          count by (namespace,service,cluster) (
            changes(process_start_time_seconds{job="cloudeka-kube-prometheus-s-alertmanager",namespace="monitoring"}[10m]) > 4
          )
        /
          count by (namespace,service,cluster) (
            up{job="cloudeka-kube-prometheus-s-alertmanager",namespace="monitoring"}
...
### k8s.rules.container-cpu-usage-second
...
metadata:
  labels:
    app: deka-metric
    observability.cloudeka.ai/release: deka-metric
  name: k8s.rules.container-cpu-usage-second
  namespace: observability
spec:
  groups:
...
metadata:
  labels:
    app: deka-metric
    observability.cloudeka.ai/release: deka-metric
  name: k8s.rules.container-memory-cache
  namespace: observability
spec:
  groups:
...
metadata:
  labels:
    app: deka-metric
    observability.cloudeka.ai/release: deka-metric
  name: k8s.rules.container-memory-rss
  namespace: observability
spec:
  groups:
...
metadata:
  labels:
    app: deka-metric
    observability.cloudeka.ai/release: deka-metric
  name: k8s.rules.container-memory-swap
  namespace: observability
spec:
  groups:
...
metadata:
  labels:
    app: deka-metric
    observability.cloudeka.ai/release: deka-metric
  name: k8s.rules.container-memory-working-set-bytes
  namespace: observability
spec:
  groups:
...
metadata:
  labels:
    app: deka-metric
    observability.cloudeka.ai/release: deka-metric
  name: k8s.rules.container-resource
  namespace: observability
spec:
  groups:
...
spec:
  ...
  - name: prometheus-operator
    ...
    - alert: PrometheusOperatorListErrors
      ...
      expr: (sum by (cluster,controller,namespace) (rate(prometheus_operator_list_operations_failed_total{job="cloudeka-kube-prometheus-s-operator",namespace="monitoring"}[10m]))
        / sum by (cluster,controller,namespace) (rate(prometheus_operator_list_operations_total{job="cloudeka-kube-prometheus-s-operator",namespace="monitoring"}[10m])))
        > 0.4
      for: 15m
      labels:
        severity: warning
    - alert: PrometheusOperatorWatchErrors
      ...
      expr: (sum by (cluster,controller,namespace) (rate(prometheus_operator_watch_operations_failed_total{job="cloudeka-kube-prometheus-s-operator",namespace="monitoring"}[5m]))
        / sum by (cluster,controller,namespace) (rate(prometheus_operator_watch_operations_total{job="cloudeka-kube-prometheus-s-operator",namespace="monitoring"}[5m])))
        > 0.4
      for: 15m
      labels:
        severity: warning
    - alert: PrometheusOperatorSyncFailed
      ...
      expr: min_over_time(prometheus_operator_syncs{status="failed",job="cloudeka-kube-prometheus-s-operator",namespace="monitoring"}[5m])
        > 0
      for: 10m
      labels:
        severity: warning
    - alert: PrometheusOperatorReconcileErrors
      ...
      expr: (sum by (cluster,controller,namespace) (rate(prometheus_operator_reconcile_errors_total{job="cloudeka-kube-prometheus-s-operator",namespace="monitoring"}[5m])))
        / (sum by (cluster,controller,namespace) (rate(prometheus_operator_reconcile_operations_total{job="cloudeka-kube-prometheus-s-operator",namespace="monitoring"}[5m])))
        > 0.1
      for: 10m
      labels:
        severity: warning
    - alert: PrometheusOperatorStatusUpdateErrors
      ...
      expr: (sum by (cluster,controller,namespace) (rate(prometheus_operator_status_update_errors_total{job="cloudeka-kube-prometheus-s-operator",namespace="monitoring"}[5m])))
        / (sum by (cluster,controller,namespace) (rate(prometheus_operator_status_update_operations_total{job="cloudeka-kube-prometheus-s-operator",namespace="monitoring"}[5m])))
        > 0.1
      for: 10m
      labels:
        severity: warning
    - alert: PrometheusOperatorNodeLookupErrors
      ...
      expr: rate(prometheus_operator_node_address_lookup_errors_total{job="cloudeka-kube-prometheus-s-operator",namespace="monitoring"}[5m])
        > 0.1
      for: 10m
      labels:
        severity: warning
    - alert: PrometheusOperatorNotReady
      ...
      expr: min by (cluster,controller,namespace) (max_over_time(prometheus_operator_ready{job="cloudeka-kube-prometheus-s-operator",namespace="monitoring"}[5m])
        == 0)
      for: 5m
      labels:
        severity: warning
    - alert: PrometheusOperatorRejectedResources
      ...
      expr: min_over_time(prometheus_operator_managed_resources{state="rejected",job="cloudeka-kube-prometheus-s-operator",namespace="monitoring"}[5m])
        > 0
      for: 5m
      labels:
        severity: warning
  ...
  - name: prometheus
    ...
    - alert: PrometheusBadConfig
      ...
      expr: |-
        # Without max_over_time, failed scrapes could create false negatives, see
        # https://www.robustperception.io/alerting-on-gauges-in-prometheus-2-0 for details.
        max_over_time(prometheus_config_last_reload_successful{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m]) == 0
      for: 10m
      labels:
        severity: critical
    - alert: PrometheusSDRefreshFailure
      ...
      expr: increase(prometheus_sd_refresh_failures_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[10m])
        > 0
      for: 20m
      labels:
        severity: warning
    - alert: PrometheusKubernetesListWatchFailures
      ...
      expr: increase(prometheus_sd_kubernetes_failures_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        > 0
      for: 15m
      labels:
        severity: warning
    - alert: PrometheusNotificationQueueRunningFull
      ...
      expr: |-
        ...
        # https://www.robustperception.io/alerting-on-gauges-in-prometheus-2-0 for details.
        (
          predict_linear(prometheus_notifications_queue_length{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m], 60 * 30)
        >
          min_over_time(prometheus_notifications_queue_capacity{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        )
      for: 15m
      labels:
        severity: warning
    - alert: PrometheusErrorSendingAlertsToSomeAlertmanagers
      ...
      expr: |-
        (
          rate(prometheus_notifications_errors_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        /
          rate(prometheus_notifications_sent_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        )
        * 100
        > 1
      for: 15m
    ...
    - alert: PrometheusNotConnectedToAlertmanagers
      ...
      expr: |-
        # Without max_over_time, failed scrapes could create false negatives, see
        # https://www.robustperception.io/alerting-on-gauges-in-prometheus-2-0 for details.
        max_over_time(prometheus_notifications_alertmanagers_discovered{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m]) < 1
      for: 10m
      labels:
        severity: warning
    - alert: PrometheusTSDBReloadsFailing
      ...
      expr: increase(prometheus_tsdb_reloads_failures_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[3h])
        > 0
      for: 4h
      labels:
        severity: warning
    - alert: PrometheusTSDBCompactionsFailing
      ...
      expr: increase(prometheus_tsdb_compactions_failed_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[3h])
        > 0
      for: 4h
      labels:
        severity: warning
    - alert: PrometheusNotIngestingSamples
      ...
      expr: |-
        (
          sum without(type) (rate(prometheus_tsdb_head_samples_appended_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])) <= 0
        and
          (
            sum without(scrape_job) (prometheus_target_metadata_cache_entries{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}) > 0
          or
            sum without(rule_group) (prometheus_rule_group_rules{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}) > 0
          )
        )
      for: 10m
      labels:
    ...
    - alert: PrometheusDuplicateTimestamps
      ...
      expr: rate(prometheus_target_scrapes_sample_duplicate_timestamp_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        > 0
      for: 10m
      labels:
        severity: warning
    - alert: PrometheusOutOfOrderTimestamps
      ...
      expr: rate(prometheus_target_scrapes_sample_out_of_order_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        > 0
      for: 10m
      labels:
        severity: warning
    - alert: PrometheusRemoteStorageFailures
      ...
      expr: |-
        (
          (rate(prometheus_remote_storage_failed_samples_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m]) or rate(prometheus_remote_storage_samples_failed_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m]))
        /
          (
            (rate(prometheus_remote_storage_failed_samples_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m]) or rate(prometheus_remote_storage_samples_failed_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m]))
          +
            (rate(prometheus_remote_storage_succeeded_samples_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m]) or rate(prometheus_remote_storage_samples_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m]))
          )
        )
        * 100
        > 1
    ...
    - alert: PrometheusRemoteWriteBehind
      ...
      expr: |-
        ...
        # https://www.robustperception.io/alerting-on-gauges-in-prometheus-2-0 for details.
        (
          max_over_time(prometheus_remote_storage_highest_timestamp_in_seconds{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        - ignoring(remote_name, url) group_right
          max_over_time(prometheus_remote_storage_queue_highest_sent_timestamp_seconds{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        )
        > 120
      for: 15m
      labels:
    ...
    - alert: PrometheusRemoteWriteDesiredShards
      annotations:
        description: Prometheus {{$labels.namespace}}/{{$labels.pod}} remote write
          ...
          printf `prometheus_remote_storage_shards_max{instance="%s",job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}`
      ...
      expr: |-
        ...
        # https://www.robustperception.io/alerting-on-gauges-in-prometheus-2-0 for details.
        (
          max_over_time(prometheus_remote_storage_shards_desired{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        >
          max_over_time(prometheus_remote_storage_shards_max{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        )
      for: 15m
      labels:
        severity: warning
    - alert: PrometheusRuleFailures
      ...
      expr: increase(prometheus_rule_evaluation_failures_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        > 0
      for: 15m
      labels:
        severity: critical
    - alert: PrometheusMissingRuleEvaluations
      ...
      expr: increase(prometheus_rule_group_iterations_missed_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        > 0
      for: 15m
      labels:
        severity: warning
    - alert: PrometheusTargetLimitHit
      annotations:
        ...
        summary: Prometheus has dropped targets because some scrape configs have exceeded
          the targets limit.
      expr: increase(prometheus_target_scrape_pool_exceeded_target_limit_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        > 0
      for: 15m
      labels:
        severity: warning
    - alert: PrometheusLabelLimitHit
      annotations:
        ...
        summary: Prometheus has dropped targets because some scrape configs have exceeded
          the labels limit.
      expr: increase(prometheus_target_scrape_pool_exceeded_label_limits_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        > 0
      for: 15m
      labels:
        severity: warning
    - alert: PrometheusScrapeBodySizeLimitHit
      ...
      expr: increase(prometheus_target_scrapes_exceeded_body_size_limit_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        > 0
      for: 15m
      labels:
        severity: warning
    - alert: PrometheusScrapeSampleLimitHit
      annotations:
        ...
        summary: Prometheus has failed scrapes that have exceeded the configured sample
          limit.
      expr: increase(prometheus_target_scrapes_exceeded_sample_limit_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        > 0
      for: 15m
      labels:
        severity: warning
    - alert: PrometheusTargetSyncFailure
      ...
      expr: increase(prometheus_target_sync_failed_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[30m])
        > 0
      for: 5m
      labels:
        severity: critical
    - alert: PrometheusHighQueryLoad
      ...
      expr: avg_over_time(prometheus_engine_queries{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        / max_over_time(prometheus_engine_queries_concurrent_max{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring"}[5m])
        > 0.8
      for: 15m
      labels:
        severity: warning
    - alert: PrometheusErrorSendingAlertsToAnyAlertmanager
      ...
      expr: |-
        min without (alertmanager) (
          rate(prometheus_notifications_errors_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring",alertmanager!~``}[5m])
        /
          rate(prometheus_notifications_sent_total{job="cloudeka-kube-prometheus-s-prometheus",namespace="monitoring",alertmanager!~``}[5m])
        )
        * 100
        > 3
      for: 15m
